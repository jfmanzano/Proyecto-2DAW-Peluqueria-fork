<div>
    <div class="flex flex-row-reverse mx-6 my-auto">
        <button data-tooltip-target="tooltip-nmarca" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
            wire:click="$set('openCrear', true)" title="Crear Nueva Marca">
            <i class="fas fa-add"></i> <span class="max-sm:hidden"> Nueva</span>
        </button>
        <div id="tooltip-nmarca" role="tooltip"
